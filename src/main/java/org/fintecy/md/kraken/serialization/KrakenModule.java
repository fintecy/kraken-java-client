...
import org.fintecy.md.kraken.serialization.model.*;
import org.fintecy.md.kraken.serialization.responses.*;
...
public class KrakenModule extends SimpleModule {
    ...
    public KrakenModule() {
        ...
        addDeserializer(Spread.class, SpreadDeserializer.INSTANCE);
        addDeserializer(SpreadResponse.class, SpreadResponseDeserializer.INSTANCE);
